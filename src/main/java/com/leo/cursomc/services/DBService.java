...
import com.leo.cursomc.domain.PagamentoComCartao;
...
import com.leo.cursomc.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatebase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "jlcb1209@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "leoprogamer57@gmail.com", "72324772019", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli1.getTelefones().addAll(Arrays.asList("36298785", "93569875"));
		...
		ped2.getItens().addAll(Arrays.asList(ip3, ip2));
